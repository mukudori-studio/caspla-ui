  ...
  return (
    <div className={styles['o-sns-links']}>
      ...
      <div className={styles['o-sns-links__sites']}>
        { (siteUrl !== '' && siteUrl !== null) && <a className={[styles['o-sns-links__button'],buttonStyles['a-button'],buttonStyles['a-button--primary'],buttonStyles['a-button--small']].join(' ')} href={siteUrl} target="_blank">公式サイト</a> }
        { (blogUrl !== '' && blogUrl !== null) && <a className={[styles['o-sns-links__button'],buttonStyles['a-button'],buttonStyles['a-button--primary'],buttonStyles['a-button--small']].join(' ')} href={blogUrl} target="_blank">ブログ</a>}
      </div>
