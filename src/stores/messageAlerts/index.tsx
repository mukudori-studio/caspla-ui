...
export const CURRENT_PASSWORD_NOT_MATCHED = 'Current password is not matched with given password'
...
export const INVALID_FURIGANA = '全角カタカナで入力してください。';
...
export const PASSWORDS_NOT_MATCHING = 'Given new passwords are not matching.'
